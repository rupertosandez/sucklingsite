...
- Badge names keep standard title case.
...
- Groundwork for strands. Nothing to see yet.
...
- Missing posters for some rentals on the home page and in review threads.

## [3.9.2] - 2026-08-24

### Removed

- An old request link on film lookups.
...
- Some MacGuffin cards and sets showed two emoji instead of one.

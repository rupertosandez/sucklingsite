...
### `/mystickers`
list the stickers you have found. stickers drop as you use the site and when you return a tape; you put them together into a title on the site.
...
- A search can also name a TMDB id, as `tmdb:603` or a pasted themoviedb.org link.
...
set the forum channel where rental reviews post. the bot needs create public threads and send messages in threads permissions. auto-detects rental, review, and recommendation forum tags if they exist.
